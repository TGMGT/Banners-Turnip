...
deps="pkg-config libdrm-dev libdrm2 libdrm-intel1 libdrm-amdgpu1 libdrm-nouveau2 ninja patchelf unzip curl pip flex bison zip git perl glslangValidator python3"
